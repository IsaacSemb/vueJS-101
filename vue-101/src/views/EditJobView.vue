...
const form = reactive(
    ...
    {
        type: 'Remote', // had to be one of the options otherwise will be empty
        title: '',
        location: '',
        description: '',
        salary: '',
...
const handleSubmit = async ()=>{
    ...
    try {
        ...
        console.error(error);
        toast.error("Job Not Updated. Please try again")
    }
}
...
onMounted(
  async () => {
    ...
    //   populate the form
    form.type = jobState.job.type
    form.title = jobState.job.title
    form.location = jobState.job.location
    form.description = jobState.job.description
    form.salary = jobState.job.salary
    form.company.name = jobState.job.company.name
    form.company.description = jobState.job.company.description
    form.company.contactEmail = jobState.job.company.contactEmail
    form.company.contactPhone = jobState.job.company.contactPhone
